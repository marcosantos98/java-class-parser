...
// unsigned int readU4(unsigned int cursor, const char *buff) {
//     // clang-format off
//     return (readU1(cursor, buff) << 24)
//     | (readU1(cursor + 1, buff) << 16)
//     | (readU1(cursor + 2, buff) << 8)
//     | (buff[cursor + 3] & 0xFF);
//     // clang-format on
// }
